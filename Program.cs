...
namespace Coffee_Shop
{
     public class CoffeeShop
     {
        ...
        public CoffeeShop(int amountVanilla, int amountChocolate, string paymentType, int
        paymentCredit)
        {
        ...
        private string customerPaymentMethod(string paymentType, int paymentCredit)
        {
            ...
            {
                message = ("Thank you for buying from us. Here is your remaining change = " +
                remaining); //concatinate mutable 
            }
        ...
        private int totalNumberOfCoffeesInStock(int amountOfVanillaCoffee, int
        amountOfChocolateCoffee)
        {
        ...
        public static void Main()
        {
            ...
            CoffeeShop customerOne = new CoffeeShop(amountOfVanilla,
            amountOfChocolate, paymentType, paymentCredit);
        }
    }
}
